...
_Updated September 6, 2026. This page describes the code available on the
...
- A versioned AI product-eval suite covering 14 integrated journeys across all
  six AI-enabled surfaces, including useful, adversarial, and unavailable-AI
  outcomes.
...
- GitHub Actions validates frontend lint, TypeScript, deterministic smoke,
  production build, AI product journeys, backend gates, offline model-eval
  graders, generated safety evidence, dependency posture, and owner-only
  Firestore rules on Windows.
...
- Automated product journeys do not replace moderated task testing; perceived
  helpfulness, trust, and interaction friction still need human evidence.
