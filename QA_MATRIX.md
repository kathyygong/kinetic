...
| Mobile companion state matrix | `cd frontend && npm run smoke` | Default smoke covers readiness, calendar, intake, and check-in decision states without browser dependencies |
