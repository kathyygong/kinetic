...
| Mobile native foundation | final Kinetic app identity, account creation/recovery, session restore, Today/Plan/Progress/Settings navigation, onboarding, progressive permissions, privacy/support/data controls | Planned Mobile Phase 5; must migrate proof-era `KineticCompanion` identifiers safely, include the deferred pattern-card VoiceOver/landscape/small-screen checks, and place notification settings permanently |
| Mobile native plan lifecycle | generate, preview, save, browse, bounded edit/regenerate/pause/resume, native preferred-day confirmation, deterministic conflict/invariant enforcement | Planned Mobile Phase 6; no normal-runner web dependency or second native planning authority |
